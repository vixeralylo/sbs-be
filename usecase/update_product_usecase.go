...
func (usecase *sbsUsecase) UpdateSbsProduct(c context.Context, sku string, quantity string, hpp float64, price float64) *response.ResponseContainer {
	...
	err := usecase.SbsRepository.UpdateSbsProduct(c, sku, qty, hpp, price)
